...
int main(int argc, char** argv) {
    ...
    struct hucre *liste2=NULL;
     ...
     liste_sirali_ekle(20, &liste2);

     liste_sirali_ekle(30, &liste2);
     liste_sirali_ekle(200, &liste2);
     liste_sirali_ekle(40, &liste2);
     liste_sirali_ekle(80, &liste2);
     liste_yaz(liste2);
     printf("\n");

     liste_eleman_sil(200, &liste2);
     liste_yaz(liste2);
     printf("\n");
